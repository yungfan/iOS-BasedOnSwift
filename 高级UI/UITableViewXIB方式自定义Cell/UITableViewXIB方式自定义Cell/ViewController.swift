...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 将XIB与当前这个UITableView绑定

        let nib: UINib = UINib(nibName: "WechatTableViewCell", bundle: nil)

        tableView.register(nib, forCellReuseIdentifier: "abc")
    }
}
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let wechat: WeChat = WeChat(picImage: pics[indexPath.row], titleText: titles[indexPath.row], timeText: times[indexPath.row], contentText: contents[indexPath.row])
